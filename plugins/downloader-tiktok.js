...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '*Hachiko-Bot*', body: null, thumbnail: imagen1, sourceUrl: 'https://instagram.com/crlx.emxn'}, mentionedJid: [m.sender]}}}, aa);
